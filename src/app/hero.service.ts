...
export class HeroService {
  ...
  addHero(hero: any): Observable<Hero> {
    return this.http.post<Hero>(`${this.heroesUrl}/addHero`, hero).pipe(
  ...
  deleteHero(id: any): Observable<Hero> {
    const url = `${this.heroesUrl}/${id}`;
  ...
  updateHero(hero: any): Observable<any> {
    ...
    const url = `${this.heroesUrl}/${hero.id}`; // Update the URL with the hero's ID
